...
export PACKLIBS="-ldcicpp -lbasematrices -lcholmod -lamd -lcolamd -lccolamd -lcamd -lmetis -ldmumps -lmumps_common -lpord -lmpiseq -lgoto2 -lgfortran -lgfortranbegin -lpthread -pg -lrt"
